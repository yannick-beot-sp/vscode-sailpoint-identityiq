...
export const COMMANDS = {
    ...
    exportObjectsBulk: "iiq.export-objects-bulk",
...
export const CONFIGURATION = {
    ...
    bulkExportFilename: "iiq.export.bulkExport.filename",
    bulkExportClassNames: "iiq.export.bulkExport.classNames",
    bulkExportRegexFilter: "iiq.export.bulkExport.regexFilter",
    bulkExportFromDate: "iiq.export.bulkExport.fromDate",
    bulkExportBundleFilter: "iiq.export.bulkExport.bundleFilter",
    bulkExportBundleTypeFilter: "iiq.export.bulkExport.bundleTypeFilter",
    bulkExportAddCData: "iiq.export.bulkExport.addCData",
    bulkExportStripMetadata: "iiq.export.bulkExport.stripMetadata",
    bulkExportStripTDEmailMetadata: "iiq.export.bulkExport.stripTDEmailMetadata",
    bulkExportStripProfiles: "iiq.export.bulkExport.stripProfiles",
    bulkExportStripRoleMetadata: "iiq.export.bulkExport.stripRoleMetadata",
    bulkExportCustomIgnore: "iiq.export.bulkExport.customIgnore",
    bulkExportSortObjectConfigIdentity: "iiq.export.bulkExport.sortObjectConfigIdentity",
    bulkExportTargetPropsFile: "iiq.export.bulkExport.targetPropsFile",
    bulkExportSimplePropsFile: "iiq.export.bulkExport.simplePropsFile",
    bulkExportMergeCompareDirPath: "iiq.export.bulkExport.mergeCompareDirPath",
    bulkExportIgnoreDirPath: "iiq.export.bulkExport.ignoreDirPath",
    bulkExportModelDirPath: "iiq.export.bulkExport.modelDirPath",
    bulkExportResolveIdsToNames: "iiq.export.bulkExport.resolveIdsToNames",
