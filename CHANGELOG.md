...
- Extension icon, derived from the activity bar icon, so the extension is identifiable in the extension list and on the Marketplace.
- Keyboard shortcut to import the XML file in the active editor: **Ctrl+Alt+S** (Windows, Linux, macOS).
